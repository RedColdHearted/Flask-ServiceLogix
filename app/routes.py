...
from .main.views import home, login, register, logout, profile, create_repair_request, edit_repair_request, \
    info_repair_request, search_results, complete_repair_request, delete_repair_request
...
def register_routes(app, db):
    ...
    main.add_url_rule('/profile/complete-request/<uuid:pk>', 'complete_repair_request', complete_repair_request, methods=['GET', 'POST'])
    main.add_url_rule('/profile/delete-request/<uuid:pk>', 'delete_repair_request', delete_repair_request, methods=['GET', 'POST'])
    main.add_url_rule('/profile/search', 'search_repair_request', search_results, methods=['GET', 'POST'])
