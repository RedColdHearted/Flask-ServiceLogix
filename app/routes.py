...
from .main.views import home, login, register, logout, profile, create_repair_request, edit_repair_request, \
    info_repair_request, search_results, complete_repair_request
...
def register_routes(app, db):
    ...
    main.add_url_rule('/profile/create-request', 'create_repair_request', create_repair_request,  methods=['GET', 'POST'])
